...
<section class="mt-4 mb-4">
  <div class="container">
    <div class="row">
      ...
      <button class="bg-dark rounded-2 text-white pt-2 pb-2 fs-5 fw-400 mt-4" onclick = "history.back()"> Please check the spelling or try searching something else </button>
      </div>
     </div> 
</div>
</section>
