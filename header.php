...
<nav class="navbar sticky-top navbar-expand-lg bg-white">
    <div class="container-fluid">
      <a class="navbar-brand" href="home.php"><img src="assets/images/TradersFind.webp" alt="TradersFind" width="110" height="70" />
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a class="btn-primary-gradiant" href="post-buy-requirements.php">Post Buy Requirements</a>
        <ul class="navigation">
          ...
          <li class="has-sub-menu">
            For Seller
            <ul>
              <li><a href="registration.php">Sell Your Products</a></li>
          ...
          <li class="has-sub-menu">
            ...
            <ul>
              ...
              <li><a href="send-feedback.php">Raise a Complaint</a></li>
        ...
        <div class="login-button-top" *ngIf="this.userName==''">
          ...
          <a href="signIn.php" class="border-end-black px-3 me-3 lh-sm">Sign In</a>
