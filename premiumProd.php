                    ...
                    <div class="col-lg-7 mt-4">
                        <div class="d-flex flex-wrap flex-md-nowrap">
                            ...
                            <div class="text-white lh-sm ms-md-2">
                                ...
                                <?php endif; ?>
                                <a href="<?php echo $urlService->getProductUrl(isset($premiumprod['productUrl'])?$premiumprod['productUrl']: $premiumprod['productName'],$premiumprod['id']) ?>" target="_blank" title="<?php echo isset($premiumprod['seller'])?$premiumprod['seller']['sellerCompanyName']:'' ?>" class="fwbold d-block" style="padding-left: 82px; color: yellow;">
                                    ...View more
                                </a>
