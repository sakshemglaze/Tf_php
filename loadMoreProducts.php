          ...
          foreach ($prod as $inde => $onep) {
            ...
            if (is_object($onep) && isset($onep->id)) {
                ...
                $reletedselId=$prodData->id ;
                        ...
                        $PmodalId='popuppluscardModalproduct2' . $indexr;
                //print_r($prodData);
                ?>
                <div class= "col-lg-6 ">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    $formattedString = '';
                    foreach ($reletedSubCategory as $index => $subcategory6) {
                        $url = $urlService->getCategoryUrl($subcategory6);
                        if ($index == 0) {
                            $formattedString .= '<a href="' . $url . '">' . $subcategory6 . '</a>';
                        } else {
                            $formattedString .= ' | <a href="' . $url . '">' . $subcategory6 . '</a>';
                        }
                    }
