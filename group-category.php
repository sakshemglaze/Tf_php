        ...
        $data =  get(
          'api/guest/products-categorie-name/' . $matches[1] .'?size=' . $size . '&sort=categoryName,asc',
              ...
              $SeoParams = [
                ...
                'fbDescription' => isset($data1->fbDescription) && $data1->fbDescription != '' ? $data1->fbDescription : '',
                ...
                'twitterDescription' => isset($data1->twitterDescription) && $data1->twitterDescription != '' ? $data1->twitterDescription : '',
